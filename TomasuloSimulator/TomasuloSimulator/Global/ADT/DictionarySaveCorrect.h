...
static inline DictionaryEntry *createDictionaryEntry (Dictionary *table, int *key, RSRow *value) {
...
static inline DictionaryEntry *getValueChainByDictionaryKey (Dictionary *table, int *key) {
...
static inline void addDictionaryEntry (Dictionary *table, int *key, void *value) {
...
static inline void removeDictionaryEntriesByKey (Dictionary *table, int *key) {
	DictionaryEntry *previous;
	DictionaryEntry *current;
	DictionaryEntry *match = NULL;
...
/*
static inline void removeDictionaryEntryByKeyValue (Dictionary *table, int *key, void *value) {
